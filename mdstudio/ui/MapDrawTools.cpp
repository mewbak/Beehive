...
namespace drawtools
{
	...
	ion::Matrix4 CalcBoxDrawMatrix(const ion::Vector2i& boxStart, const ion::Vector2i& boxEnd, const ion::Vector2i& mapSizePx, float z, bool invertY)
	{
		...
		ion::Vector3 boxScale(width, invertY ? -height : height, 0.0f);
