...
MainWindowBase::MainWindowBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxMenuItem* m_menuItemProjAssets;
	m_menuItemProjAssets = new wxMenuItem( m_menuProject, wxID_BTN_PROJ_ASSETS, wxString( wxT("Asset Management") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuProject->Append( m_menuItemProjAssets );
	...
	m_menuProject->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainWindowBase::OnBtnProjAssets ), this, m_menuItemProjAssets->GetId());
...
DialogNewPalette::DialogNewPalette( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	bSizer2->Add( m_paletteView, 0, wxALL|wxEXPAND, 5 );
...
DialogNewPalette::~DialogNewPalette()
{
}

DialogMatchPalette::DialogMatchPalette( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_text1 = new wxStaticText( this, wxID_ANY, wxT("Palette:"), wxDefaultPosition, wxSize( 60,-1 ), 0 );
	m_text1->Wrap( -1 );
	fgSizer22->Add( m_text1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	fgSizer22->Add( m_choicePalette, 0, wxALL|wxEXPAND, 5 );
	...
	m_paletteViewOld = new PaletteViewCtrl( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewOld->SetMinSize( wxSize( 32,32 ) );

	fgSizer69->Add( m_paletteViewOld, 0, wxALL|wxEXPAND, 5 );
	...
	m_staticText85 = new wxStaticText( this, wxID_ANY, wxT("Match:"), wxDefaultPosition, wxSize( 60,-1 ), 0 );
	m_staticText85->Wrap( -1 );
	fgSizer70->Add( m_staticText85, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_paletteViewNew = new PaletteViewCtrl( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewNew->SetMinSize( wxSize( 32,32 ) );

	fgSizer70->Add( m_paletteViewNew, 0, wxALL|wxEXPAND, 5 );
	...
	// Connect Events
	m_choicePalette->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogMatchPalette::OnChoicePalette ), NULL, this );
	m_btnMatch->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogMatchPalette::OnBtnMatch ), NULL, this );
	m_btnNew->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogMatchPalette::OnBtnNew ), NULL, this );
}

DialogMatchPalette::~DialogMatchPalette()
{
	// Disconnect Events
	m_choicePalette->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogMatchPalette::OnChoicePalette ), NULL, this );
	m_btnMatch->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogMatchPalette::OnBtnMatch ), NULL, this );
	m_btnNew->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogMatchPalette::OnBtnNew ), NULL, this );
...
SpriteAnimEditorDialogBase::SpriteAnimEditorDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxFlexGridSizer* fgSizer14;
	fgSizer14 = new wxFlexGridSizer( 0, 0, 0, 0 );
	fgSizer14->AddGrowableCol( 0 );
	...
	m_sizerTimeline = new wxFlexGridSizer( 0, 1, 0, 0 );
...
MatchTilesetDialogBase::MatchTilesetDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	fgSizer110->AddGrowableCol( 1 );
	fgSizer110->SetFlexibleDirection( wxBOTH );
	fgSizer110->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText143 = new wxStaticText( this, wxID_ANY, wxT("Tileset:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText143->Wrap( -1 );
	fgSizer110->Add( m_staticText143, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	wxArrayString m_choiceTilesetChoices;
	m_choiceTileset = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceTilesetChoices, 0 );
	m_choiceTileset->SetSelection( 0 );
	fgSizer110->Add( m_choiceTileset, 0, wxALL|wxEXPAND, 5 );


	fgSizer111->Add( fgSizer110, 1, wxEXPAND, 5 );

	wxBoxSizer* bSizer85;
	bSizer85 = new wxBoxSizer( wxHORIZONTAL );

	wxStaticBoxSizer* sbSizer12;
	sbSizer12 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Imported") ), wxVERTICAL );

	sbSizer12->SetMinSize( wxSize( -1,450 ) );
	m_canvasTilesImported = new TilesPanel( sbSizer12->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	m_canvasTilesImported->SetMinSize( wxSize( -1,400 ) );

	sbSizer12->Add( m_canvasTilesImported, 1, wxEXPAND | wxALL, 5 );


	bSizer85->Add( sbSizer12, 1, wxALL|wxEXPAND, 5 );

	wxStaticBoxSizer* sbSizer13;
	sbSizer13 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Match") ), wxVERTICAL );

	sbSizer13->SetMinSize( wxSize( -1,450 ) );
	m_canvasTilesMatch = new TilesPanel( sbSizer13->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	m_canvasTilesMatch->SetMinSize( wxSize( -1,400 ) );

	sbSizer13->Add( m_canvasTilesMatch, 1, wxEXPAND | wxALL, 5 );


	bSizer85->Add( sbSizer13, 1, wxALL|wxEXPAND, 5 );


	fgSizer111->Add( bSizer85, 1, wxEXPAND, 5 );

	wxBoxSizer* bSizer84;
	bSizer84 = new wxBoxSizer( wxHORIZONTAL );

	m_btnMatch = new wxButton( this, wxID_ANY, wxT("Merge"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer84->Add( m_btnMatch, 0, wxALL, 5 );

	m_btnNew = new wxButton( this, wxID_ANY, wxT("New"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer84->Add( m_btnNew, 0, wxALL, 5 );


	fgSizer111->Add( bSizer84, 1, wxALIGN_RIGHT|wxEXPAND, 5 );
	...
	// Connect Events
	m_choiceTileset->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( MatchTilesetDialogBase::OnChoiceTileset ), NULL, this );
	m_btnMatch->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MatchTilesetDialogBase::OnBtnMatch ), NULL, this );
	m_btnNew->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MatchTilesetDialogBase::OnBtnNew ), NULL, this );
}

MatchTilesetDialogBase::~MatchTilesetDialogBase()
{
	// Disconnect Events
	m_choiceTileset->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( MatchTilesetDialogBase::OnChoiceTileset ), NULL, this );
	m_btnMatch->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MatchTilesetDialogBase::OnBtnMatch ), NULL, this );
	m_btnNew->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MatchTilesetDialogBase::OnBtnNew ), NULL, this );

}

DialogNewMapBase::DialogNewMapBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	fgSizer114 = new wxFlexGridSizer( 0, 3, 0, 0 );
	fgSizer114->SetFlexibleDirection( wxBOTH );
	fgSizer114->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText153 = new wxStaticText( this, wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText153->Wrap( -1 );
	fgSizer114->Add( m_staticText153, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );

	m_txtName = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_txtName->SetMinSize( wxSize( 300,-1 ) );

	fgSizer114->Add( m_txtName, 0, wxALL, 5 );


	fgSizer114->Add( 0, 0, 1, wxEXPAND, 5 );

	m_staticText155 = new wxStaticText( this, wxID_ANY, wxT("Size:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText155->Wrap( -1 );
	fgSizer114->Add( m_staticText155, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );

	wxBoxSizer* bSizer86;
	bSizer86 = new wxBoxSizer( wxHORIZONTAL );

	m_spinWidth = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 32, 512 );
	m_spinWidth->SetMinSize( wxSize( 50,-1 ) );

	bSizer86->Add( m_spinWidth, 0, wxALL, 5 );

	m_staticText156 = new wxStaticText( this, wxID_ANY, wxT("x"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText156->Wrap( -1 );
	bSizer86->Add( m_staticText156, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_spinHeight = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 512, 16 );
	m_spinHeight->SetMinSize( wxSize( 50,-1 ) );

	bSizer86->Add( m_spinHeight, 0, wxALL, 5 );

	m_staticText157 = new wxStaticText( this, wxID_ANY, wxT("stamps"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText157->Wrap( -1 );
	bSizer86->Add( m_staticText157, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );


	fgSizer114->Add( bSizer86, 1, wxEXPAND, 5 );


	fgSizer114->Add( 0, 0, 1, wxEXPAND, 5 );

	m_staticText154 = new wxStaticText( this, wxID_ANY, wxT("Stamp set:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText154->Wrap( -1 );
	fgSizer114->Add( m_staticText154, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );

	wxArrayString m_choiceStampSetChoices;
	m_choiceStampSet = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceStampSetChoices, 0 );
	m_choiceStampSet->SetSelection( 0 );
	m_choiceStampSet->SetMinSize( wxSize( 300,-1 ) );

	fgSizer114->Add( m_choiceStampSet, 0, wxALL, 5 );

	m_btnNewStampSet = new wxButton( this, wxID_ANY, wxT("New..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer114->Add( m_btnNewStampSet, 0, wxALL, 5 );


	fgSizer113->Add( fgSizer114, 1, wxEXPAND, 5 );
	...
	fgSizer113->Add( m_sdbSizer12, 1, wxEXPAND, 5 );
	...
	// Connect Events
	m_choiceStampSet->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogNewMapBase::OnChoiceStampSet ), NULL, this );
	m_btnNewStampSet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogNewMapBase::OnBtnNewStampSet ), NULL, this );
}

DialogNewMapBase::~DialogNewMapBase()
{
	// Disconnect Events
	m_choiceStampSet->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogNewMapBase::OnChoiceStampSet ), NULL, this );
	m_btnNewStampSet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogNewMapBase::OnBtnNewStampSet ), NULL, this );
...
DialogAssetsBase::DialogAssetsBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_tabPalettes = new wxPanel( m_tabs, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	...
	sbSizer3 = new wxStaticBoxSizer( new wxStaticBox( m_tabPalettes, wxID_ANY, wxT("Manage") ), wxVERTICAL );
	...
	m_btnImportPalette = new wxButton( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Import"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer75->Add( m_btnImportPalette, 0, wxALL, 5 );

	m_btnExportPalette = new wxButton( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer75->Add( m_btnExportPalette, 0, wxALL, 5 );

	m_btnRenamePalette = new wxButton( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Rename"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer75->Add( m_btnRenamePalette, 0, wxALL, 5 );

	m_btnDeletePalette = new wxButton( sbSizer3->GetStaticBox(), wxID_ANY, wxT("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer75->Add( m_btnDeletePalette, 0, wxALL, 5 );
	...
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( m_tabPalettes, wxID_ANY, wxT("Details") ), wxVERTICAL );
	...
	fgSizer76->Add( m_txtPaletteName, 0, wxALL, 5 );
	...
	m_paletteViewSelected = new PaletteViewCtrl( m_tabPalettes, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewSelected->SetMinSize( wxSize( 32,32 ) );

	fgSizer71->Add( m_paletteViewSelected, 0, wxALL|wxEXPAND, 5 );
	...
	m_btnExportTileset = new wxButton( sbSizer311->GetStaticBox(), wxID_ANY, wxT("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer7511->Add( m_btnExportTileset, 0, wxALL, 5 );

	m_btnCleanupTileset = new wxButton( sbSizer311->GetStaticBox(), wxID_ANY, wxT("Cleanup"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer7511->Add( m_btnCleanupTileset, 0, wxALL, 5 );
	...
	wxFlexGridSizer* fgSizer721;
	fgSizer721 = new wxFlexGridSizer( 0, 2, 0, 0 );
	fgSizer721->AddGrowableCol( 1 );
	fgSizer721->SetFlexibleDirection( wxBOTH );
	fgSizer721->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxFlexGridSizer* fgSizer90;
	fgSizer90 = new wxFlexGridSizer( 2, 1, 0, 0 );
	...
	m_staticText126 = new wxStaticText( m_tabStamps, wxID_ANY, wxT("Stamp sets:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText126->Wrap( -1 );
	fgSizer90->Add( m_staticText126, 0, wxALL, 5 );

	m_listStampSets = new wxListBox( m_tabStamps, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	m_listStampSets->SetMinSize( wxSize( 230,250 ) );

	fgSizer90->Add( m_listStampSets, 0, wxALL|wxEXPAND, 5 );


	fgSizer721->Add( fgSizer90, 1, wxEXPAND, 5 );

	wxFlexGridSizer* fgSizer731;
	fgSizer731 = new wxFlexGridSizer( 2, 1, 0, 0 );
	fgSizer731->AddGrowableCol( 0 );
	fgSizer731->SetFlexibleDirection( wxBOTH );
	fgSizer731->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxFlexGridSizer* fgSizer741;
	fgSizer741 = new wxFlexGridSizer( 1, 2, 0, 0 );
	fgSizer741->SetFlexibleDirection( wxBOTH );
	fgSizer741->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxStaticBoxSizer* sbSizer31;
	sbSizer31 = new wxStaticBoxSizer( new wxStaticBox( m_tabStamps, wxID_ANY, wxT("Manage") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer751;
	fgSizer751 = new wxFlexGridSizer( 0, 2, 0, 0 );
	fgSizer751->SetFlexibleDirection( wxBOTH );
	fgSizer751->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_btnNewStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("New"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnNewStampSet, 0, wxALL, 5 );

	m_btnDeleteStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnDeleteStampSet, 0, wxALL, 5 );

	m_btnScanStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("Re-scan"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnScanStampSet, 0, wxALL, 5 );

	m_btnExportStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnExportStampSet, 0, wxALL, 5 );

	m_btnRenameStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("Rename"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnRenameStampSet, 0, wxALL, 5 );

	m_btnCleanupStampSet = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, wxT("Cleanup"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer751->Add( m_btnCleanupStampSet, 0, wxALL, 5 );


	sbSizer31->Add( fgSizer751, 1, wxEXPAND, 5 );


	fgSizer741->Add( sbSizer31, 1, wxALL, 5 );

	wxStaticBoxSizer* sbSizer21;
	sbSizer21 = new wxStaticBoxSizer( new wxStaticBox( m_tabStamps, wxID_ANY, wxT("Details") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer761;
	fgSizer761 = new wxFlexGridSizer( 0, 2, 0, 0 );
	fgSizer761->SetFlexibleDirection( wxBOTH );
	fgSizer761->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText881 = new wxStaticText( sbSizer21->GetStaticBox(), wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	fgSizer761->Add( m_txtStampSetName, 0, wxALL, 5 );

	m_staticText901 = new wxStaticText( sbSizer21->GetStaticBox(), wxID_ANY, wxT("Id:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText941 = new wxStaticText( sbSizer21->GetStaticBox(), wxID_ANY, wxT("Tileset:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	fgSizer741->Add( sbSizer21, 1, wxALL|wxEXPAND, 5 );


	fgSizer731->Add( fgSizer741, 1, wxEXPAND, 5 );
	...
	fgSizer91->Add( m_staticText127, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );

	m_filePickerStampsImg = new wxFilePickerCtrl( m_tabStamps, wxID_ANY, wxEmptyString, wxT("Select a file"), wxT("*.bmp;*.png"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE );
	m_filePickerStampsImg->SetMinSize( wxSize( 360,-1 ) );

	fgSizer91->Add( m_filePickerStampsImg, 0, wxALL, 5 );


	bSizer75->Add( fgSizer91, 1, wxEXPAND, 5 );


	fgSizer731->Add( bSizer75, 1, wxEXPAND, 5 );


	fgSizer721->Add( fgSizer731, 1, wxEXPAND, 5 );


	fgSizer711->Add( fgSizer721, 1, wxEXPAND, 5 );
	...
	m_sizerStamps->Add( m_canvasStamps, 1, wxALL|wxEXPAND, 5 );


	fgSizer711->Add( m_sizerStamps, 1, wxALL|wxEXPAND, 5 );
	...
	fgSizer712->SetFlexibleDirection( wxBOTH );
	fgSizer712->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxFlexGridSizer* fgSizer722;
	fgSizer722 = new wxFlexGridSizer( 1, 2, 0, 0 );
	fgSizer722->AddGrowableCol( 1 );
	fgSizer722->SetFlexibleDirection( wxBOTH );
	fgSizer722->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxFlexGridSizer* fgSizer1241;
	fgSizer1241 = new wxFlexGridSizer( 2, 1, 0, 0 );
	fgSizer1241->SetFlexibleDirection( wxBOTH );
	fgSizer1241->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText1811 = new wxStaticText( m_tabMaps, wxID_ANY, wxT("Maps:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1811->Wrap( -1 );
	fgSizer1241->Add( m_staticText1811, 0, wxALL, 5 );

	m_listMaps = new wxListBox( m_tabMaps, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	m_listMaps->SetMinSize( wxSize( 230,250 ) );

	fgSizer1241->Add( m_listMaps, 0, wxALL|wxEXPAND, 5 );


	fgSizer722->Add( fgSizer1241, 1, wxEXPAND, 5 );

	wxFlexGridSizer* fgSizer732;
	fgSizer732 = new wxFlexGridSizer( 2, 1, 0, 0 );
	fgSizer732->AddGrowableCol( 0 );
	fgSizer732->SetFlexibleDirection( wxBOTH );
	fgSizer732->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxFlexGridSizer* fgSizer742;
	fgSizer742 = new wxFlexGridSizer( 1, 2, 0, 0 );
	fgSizer742->SetFlexibleDirection( wxBOTH );
	fgSizer742->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxStaticBoxSizer* sbSizer32;
	sbSizer32 = new wxStaticBoxSizer( new wxStaticBox( m_tabMaps, wxID_ANY, wxT("Manage") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer752;
	fgSizer752 = new wxFlexGridSizer( 0, 2, 0, 0 );
	fgSizer752->SetFlexibleDirection( wxBOTH );
	fgSizer752->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_btnNewMap = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, wxT("New"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer752->Add( m_btnNewMap, 0, wxALL, 5 );

	m_btnDeleteMap = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, wxT("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer752->Add( m_btnDeleteMap, 0, wxALL, 5 );

	m_btnImportMap = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, wxT("Import"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer752->Add( m_btnImportMap, 0, wxALL, 5 );

	m_btnExportMap = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, wxT("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer752->Add( m_btnExportMap, 0, wxALL, 5 );

	m_btnRenameMap = new wxButton( sbSizer32->GetStaticBox(), wxID_ANY, wxT("Rename"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer752->Add( m_btnRenameMap, 0, wxALL, 5 );


	sbSizer32->Add( fgSizer752, 1, wxEXPAND, 5 );


	fgSizer742->Add( sbSizer32, 1, wxALL, 5 );

	wxStaticBoxSizer* sbSizer22;
	sbSizer22 = new wxStaticBoxSizer( new wxStaticBox( m_tabMaps, wxID_ANY, wxT("Details") ), wxVERTICAL );

	wxFlexGridSizer* fgSizer762;
	fgSizer762 = new wxFlexGridSizer( 0, 2, 0, 0 );
	fgSizer762->SetFlexibleDirection( wxBOTH );
	fgSizer762->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText882 = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText882->Wrap( -1 );
	fgSizer762->Add( m_staticText882, 0, wxALL, 5 );

	m_txtMapName = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("[None]"), wxDefaultPosition, wxDefaultSize, 0 );
	m_txtMapName->Wrap( -1 );
	m_txtMapName->SetMinSize( wxSize( 200,-1 ) );

	fgSizer762->Add( m_txtMapName, 0, wxALL, 5 );

	m_staticText902 = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("Id:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText902->Wrap( -1 );
	fgSizer762->Add( m_staticText902, 0, wxALL, 5 );
	...
	m_txtMapTileset = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("[None]"), wxDefaultPosition, wxDefaultSize, 0 );
	m_txtMapTileset->Wrap( -1 );
	fgSizer762->Add( m_txtMapTileset, 0, wxALL, 5 );

	m_staticText942 = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("Stampset:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText942->Wrap( -1 );
	fgSizer762->Add( m_staticText942, 0, wxALL, 5 );

	m_txtMapStampSet = new wxStaticText( sbSizer22->GetStaticBox(), wxID_ANY, wxT("[None]"), wxDefaultPosition, wxDefaultSize, 0 );
	m_txtMapStampSet->Wrap( -1 );
	fgSizer762->Add( m_txtMapStampSet, 0, wxALL, 5 );


	sbSizer22->Add( fgSizer762, 1, wxEXPAND, 5 );


	fgSizer742->Add( sbSizer22, 1, wxALL|wxEXPAND, 5 );


	fgSizer732->Add( fgSizer742, 1, wxEXPAND, 5 );
	...
	m_staticText246 = new wxStaticText( m_tabMaps, wxID_ANY, wxT("Background map:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText246->Wrap( -1 );
	fgSizer159->Add( m_staticText246, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	wxArrayString m_choiceBgMapChoices;
	m_choiceBgMap = new wxChoice( m_tabMaps, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceBgMapChoices, 0 );
	m_choiceBgMap->SetSelection( 0 );
	m_choiceBgMap->SetMinSize( wxSize( 360,-1 ) );

	fgSizer159->Add( m_choiceBgMap, 0, wxALL, 5 );


	fgSizer732->Add( fgSizer159, 1, wxEXPAND, 5 );


	fgSizer722->Add( fgSizer732, 1, wxEXPAND, 5 );


	fgSizer712->Add( fgSizer722, 1, wxEXPAND, 5 );

	m_sizerSlots = new wxStaticBoxSizer( new wxStaticBox( m_tabMaps, wxID_ANY, wxT("Active Palette Slots") ), wxVERTICAL );
	...
	m_staticText98 = new wxStaticText( m_sizerSlots->GetStaticBox(), wxID_ANY, wxT("0:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText98->Wrap( -1 );
	fgSizer77->Add( m_staticText98, 0, wxALL, 5 );

	wxArrayString m_choiceSlot0Choices;
	m_choiceSlot0 = new wxChoice( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceSlot0Choices, 0 );
	m_choiceSlot0->SetSelection( 0 );
	m_choiceSlot0->SetMinSize( wxSize( 200,-1 ) );

	fgSizer77->Add( m_choiceSlot0, 0, wxALL, 5 );

	m_paletteViewSlot0 = new PaletteViewCtrl( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewSlot0->SetMinSize( wxSize( 32,32 ) );

	fgSizer77->Add( m_paletteViewSlot0, 0, wxALL|wxEXPAND, 5 );

	m_staticText102 = new wxStaticText( m_sizerSlots->GetStaticBox(), wxID_ANY, wxT("1:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText102->Wrap( -1 );
	fgSizer77->Add( m_staticText102, 0, wxALL, 5 );

	wxArrayString m_choiceSlot1Choices;
	m_choiceSlot1 = new wxChoice( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceSlot1Choices, 0 );
	m_choiceSlot1->SetSelection( 0 );
	m_choiceSlot1->SetMinSize( wxSize( 200,-1 ) );

	fgSizer77->Add( m_choiceSlot1, 0, wxALL, 5 );

	m_paletteViewSlot1 = new PaletteViewCtrl( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewSlot1->SetMinSize( wxSize( 32,32 ) );

	fgSizer77->Add( m_paletteViewSlot1, 0, wxALL|wxEXPAND, 5 );

	m_staticText103 = new wxStaticText( m_sizerSlots->GetStaticBox(), wxID_ANY, wxT("2:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText103->Wrap( -1 );
	fgSizer77->Add( m_staticText103, 0, wxALL, 5 );

	wxArrayString m_choiceSlot2Choices;
	m_choiceSlot2 = new wxChoice( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceSlot2Choices, 0 );
	m_choiceSlot2->SetSelection( 0 );
	m_choiceSlot2->SetMinSize( wxSize( 200,-1 ) );

	fgSizer77->Add( m_choiceSlot2, 0, wxALL, 5 );

	m_paletteViewSlot2 = new PaletteViewCtrl( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	m_paletteViewSlot2->SetMinSize( wxSize( 32,32 ) );

	fgSizer77->Add( m_paletteViewSlot2, 0, wxALL|wxEXPAND, 5 );

	m_staticText104 = new wxStaticText( m_sizerSlots->GetStaticBox(), wxID_ANY, wxT("3:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText104->Wrap( -1 );
	fgSizer77->Add( m_staticText104, 0, wxALL, 5 );

	wxArrayString m_choiceSlot3Choices;
	m_choiceSlot3 = new wxChoice( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceSlot3Choices, 0 );
	m_choiceSlot3->SetSelection( 0 );
	m_choiceSlot3->SetMinSize( wxSize( 200,-1 ) );

	fgSizer77->Add( m_choiceSlot3, 0, wxALL, 5 );

	m_paletteViewSlot3 = new PaletteViewCtrl( m_sizerSlots->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnAutoAssignPalettes = new wxButton( m_sizerSlots->GetStaticBox(), wxID_ANY, wxT("Auto-assign"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer77->Add( m_btnAutoAssignPalettes, 0, wxALIGN_RIGHT|wxALL, 5 );


	m_sizerSlots->Add( fgSizer77, 1, wxEXPAND, 5 );


	fgSizer712->Add( m_sizerSlots, 1, wxALL|wxEXPAND, 5 );
	...
	m_btnExportTileset->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportTileset ), NULL, this );
	m_btnCleanupTileset->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnCleanupTileset ), NULL, this );
	m_filePickerTilesImg->Connect( wxEVT_COMMAND_FILEPICKER_CHANGED, wxFileDirPickerEventHandler( DialogAssetsBase::OnBrowseTilesImg ), NULL, this );
	...
	m_btnScanStampSet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnScanStampSet ), NULL, this );
	m_btnExportStampSet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportStampSet ), NULL, this );
	...
	m_listMaps->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( DialogAssetsBase::OnListMapDClick ), NULL, this );
	m_btnNewMap->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnNewMap ), NULL, this );
	m_btnDeleteMap->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnDeleteMap ), NULL, this );
	m_btnImportMap->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnImportMap ), NULL, this );
	m_btnExportMap->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportMap ), NULL, this );
	m_btnRenameMap->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnRenameMap ), NULL, this );
	m_choiceBgMap->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogAssetsBase::OnListBackgroundMap ), NULL, this );
	...
	m_btnAutoAssignPalettes->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnAutoAssignPalettes ), NULL, this );
}

DialogAssetsBase::~DialogAssetsBase()
{
	// Disconnect Events
	...
	m_btnExportTileset->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportTileset ), NULL, this );
	m_btnCleanupTileset->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnCleanupTileset ), NULL, this );
	m_filePickerTilesImg->Disconnect( wxEVT_COMMAND_FILEPICKER_CHANGED, wxFileDirPickerEventHandler( DialogAssetsBase::OnBrowseTilesImg ), NULL, this );
	...
	m_btnScanStampSet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnScanStampSet ), NULL, this );
	m_btnExportStampSet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportStampSet ), NULL, this );
	...
	m_listMaps->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( DialogAssetsBase::OnListMapDClick ), NULL, this );
	m_btnNewMap->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnNewMap ), NULL, this );
	m_btnDeleteMap->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnDeleteMap ), NULL, this );
	m_btnImportMap->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnImportMap ), NULL, this );
	m_btnExportMap->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnExportMap ), NULL, this );
	m_btnRenameMap->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnRenameMap ), NULL, this );
	m_choiceBgMap->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( DialogAssetsBase::OnListBackgroundMap ), NULL, this );
	...
	m_btnAutoAssignPalettes->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DialogAssetsBase::OnBtnAutoAssignPalettes ), NULL, this );
